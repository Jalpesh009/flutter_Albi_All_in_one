...
import 'package:flutter_demo/onboarding/pages.dart';
import 'package:flutter_demo/pager_indicator.dart';

void main() => runApp(new onboard_main());

BuildContext buildContext;

class onboard_main extends StatelessWidget {
  @override
    ...
    slideUpdateStream.stream.listen((SlideUpdate event) {
      setState(() {
        if (event.updateType == UpdateType.dragging) {
          ...
          print("nextPageIndex:- " + nextPageIndex.toString());
          print("activeIndex:- " + activeIndex.toString());

          if (nextPageIndex == 2 && activeIndex == 2) {
            _gotoOtherScreen();
          }
